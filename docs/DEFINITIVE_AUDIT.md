...
- Authority由来11,340 mapping候補の全Scenario分類113,400 Row中113,331 Rowが未作成。別の非後退分母として、公開済み29 Behavior × 10 Scenarioは290専用Artifactへ分離し、既存69 rowをbounded補助Evidenceへ接続した。Security 16 rowを固定PostgreSQL runtimeで閉じ、version lock、14.24〜18.6 compatibility、17.11→18.6 pg_upgrade/logical upgrade、schema migration、backup/restore、PITR、SIGKILL recovery、logical/physical replication、maintenance、observabilityの権限境界を含めた。strict Closureは16、Gapは274、Authority atomic bindingは0である
