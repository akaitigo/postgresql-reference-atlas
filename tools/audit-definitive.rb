...
scenario_contract_valid = scenario_summary.fetch("rows") == 290 && scenario_summary.fetch("pattern_specific_rows") == 16 && scenario_summary.fetch("pattern_specific_runtime_rows") == 16 && scenario_summary.fetch("pattern_specific_gaps") == 274 && scenario_summary.fetch("integrated_trace_rows") == 290 && scenario_summary.fetch("authority_atomic_rows") == 0 && scenario_summary.fetch("completion_eligible_rows") == 0
