...
security-next-runtime-rows-test:
	ruby tests/security-next-runtime-rows.rb

security-next-runtime-scenario-guard-test:
	ruby tests/security-next-runtime-scenario-guard.rb
